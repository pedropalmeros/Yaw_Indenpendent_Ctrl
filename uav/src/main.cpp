...
int main(int argc, char* argv[]) {
    ...
    /* If you check in the attitude applicacition, in the app code constructor, it accepts the the drone and 
    the controller as arguments, but in this case the drone is not necessary because it is created in the CircleFoller
    code*/
    PosApp* app=new PosApp(controller);
